...
const iconNameByIdIcon = weatherConditions.filter(
  (item) => item.id === idIcon.id && item.icon === idIcon.icon
);
const iconNameByIndex = weatherConditions.findIndex(
  (item) => item.id === idIcon.id && item.icon === idIcon.icon
);
const iconNameById = weatherConditions.filter((item) => item.id === idIcon.id);

console.log(iconNameByIdIcon, iconNameById, iconNameByIndex);

const iconName = iconNameByIdIcon.length > 0 ? iconNameByIdIcon : iconNameById;
